...
// const headerImage = require('..\assests\images\header.jpg');
const notification = require('../assests/images/Notification.png');
const banner = require('../assests/images/BG.png');
const fire = require('../assests/images/fire.png');
const model = require('../assests/images/model.png');
// const couple = require('../assests/images/couple.jpg');
const cycle = require('../assests/images/cycle.png');
const yoga = require('../assests/images/yoga.png');
const walk = require('../assests/images/walk.png');
const next = require('../assests/images/next.png');
const play = require('../assests/images/play.png');
const star = require('../assests/images/Star.png');
const book = require('../assests/images/Book.png');
const home = require('../assests/images/Home.png');
const heart = require('../assests/images/H.png');
const calendar = require('../assests/images/Calender.png');
const profile = require('../assests/images/User.png');
const plus = require('../assests/images/Plus.png');
